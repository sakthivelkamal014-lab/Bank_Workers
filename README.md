...
It supports operations such as depositing funds, withdrawing money, checking account balance, performing challan-based transactions, and 
calculating gold loan interest based on the weight of gold and repayment duration. The application is designed to demonstrate the practical 
...
5. Challan Transactions – Supports deposit and withdrawal through challan, If any problem in ATM.
6. Gold Loan Service – Calculates loan amount based on gold weight.
